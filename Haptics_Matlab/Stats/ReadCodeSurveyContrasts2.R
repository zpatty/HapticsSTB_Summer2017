...
baselineQ1 <- lme(Q1 ~ 1, random = ~1|Sub/Phase, data = squeezeData, method = "ML")
...
baselineQ2 <- lme(Q2 ~ 1, random = ~1|Sub/Phase, data = squeezeData, method = "ML")
...
baselineQ3 <- lme(Q3 ~ 1, random = ~1|Sub/Phase, data = squeezeData, method = "ML")
...
baselineQ4 <- lme(Q4 ~ 1, random = ~1|Sub/Phase, data = squeezeData, method = "ML")
...
baselineQ5 <- lme(Q5 ~ 1, random = ~1|Sub/Phase, data = squeezeData, method = "ML")
...
baselineQ6 <- lme(Q6 ~ 1, random = ~1|Sub/Phase, data = squeezeData, method = "ML")
...
baselineQ7 <- lme(Q7 ~ 1, random = ~1|Sub/Phase, data = squeezeData, method = "ML")
...
baselineQ8 <- lme(Q8 ~ 1, random = ~1|Sub/Phase, data = squeezeData, method = "ML")
...
baselineQ9 <- lme(Q9 ~ 1, random = ~1|Sub/Phase, data = squeezeData, method = "ML")
...
baselineQ10 <- lme(Q10 ~ 1, random = ~1|Sub/Phase, data = squeezeData, method = "ML")
...
baselineQ11 <- lme(Q11 ~ 1, random = ~1|Sub/Phase, data = squeezeData, method = "ML")
...
baselineQ12 <- lme(Q12 ~ 1, random = ~1|Sub/Phase, data = squeezeData, method = "ML")
...
by(squeezeData$Q3, list(squeezeData$Phase,squeezeData$Group),stat.desc,basic = FALSE)
#by(squeezeData$Q3, list(squeezeData$Group),stat.desc,basic = FALSE)

summary(phase_group_Q4)
by(squeezeData$Q4, list(squeezeData$Phase,squeezeData$Group),stat.desc,basic = FALSE)

summary(phase_group_Q6)
by(squeezeData$Q6, list(squeezeData$Phase,squeezeData$Group),stat.desc,basic = FALSE)
...
by(squeezeData$Q8, list(squeezeData$Phase,squeezeData$Group),stat.desc,basic = FALSE)

summary(phase_group_Q11)
by(squeezeData$Q11, list(squeezeData$Phase,squeezeData$Group),stat.desc,basic = FALSE)